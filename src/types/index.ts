...
import { IndicatorType } from '../schemas/strategy.schema';
...
/**
 * Parameters for a trading strategy. Extend as needed for each strategy type.
 */
...
/**
 * Metadata for a trade signal. Extend as needed for each strategy type.
 */
export interface TradeSignalMetadata {
  shortMA?: number;
  longMA?: number;
  rsi?: number;
  [key: string]: string | number | boolean | undefined;
...
/**
 * Strategy configuration with stricter parameters typing.
 */
...
/**
 * Rule parameters for a strategy rule.
 */
...
export interface TechnicalIndicator {
  name: string;
  type: IndicatorType;
  parameters: TechnicalIndicatorConfig;
  timeframe: string;
  description?: string;
}
