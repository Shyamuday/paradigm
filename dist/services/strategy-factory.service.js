...
exports.strategyFactory = exports.StrategyFactoryService = void 0;
const logger_1 = require("../logger/logger");
const moving_average_strategy_1 = require("./strategies/moving-average-strategy");
const rsi_strategy_1 = require("./strategies/rsi-strategy");
const breakout_strategy_1 = require("./strategies/breakout-strategy");
const options_strategy_1 = require("./strategies/options-strategy");
class StrategyFactoryService {
    ...
    registerStrategyClasses() {
        this.strategyClasses.set('TREND_FOLLOWING', moving_average_strategy_1.MovingAverageStrategy);
        this.strategyClasses.set('MEAN_REVERSION', rsi_strategy_1.RSIStrategy);
        this.strategyClasses.set('BREAKOUT', breakout_strategy_1.BreakoutStrategy);
        this.strategyClasses.set('OPTIONS_STRATEGY', options_strategy_1.OptionsStrategy);
    }
...
- Break Even: Strike ± Cost of straddle
    ...
    async createCustomStrategy(name, type, parameters, customConfig = {}) {
        const config = {
            name,
            enabled: true,
    ...
    async registerTemplate(template) {
        ...
        logger_1.logger.info(`Template registered: ${template.name}`);
    }
    getSupportedStrategyTypes() {
        return Array.from(this.strategyClasses.keys());
    }
    createDefaultMAConfig() {
        return {
            name: 'Moving Average Crossover',
            enabled: true,
    ...
    createDefaultCoveredCallConfig() {
        return {
            name: 'Covered Call Strategy',
            enabled: true,
...
exports.StrategyFactoryService = StrategyFactoryService;
exports.strategyFactory = new StrategyFactoryService();
//# sourceMappingURL=strategy-factory.service.js.map